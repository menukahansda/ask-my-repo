...
def test_already_has_git_suffix():
    assert validate_url("https://github.com/menukahansda/ask-my-repo.git") == EXPECTED
...
def test_ssh_style_url_rejected():
    assert validate_url("git@github.com:menukahansda/ask-my-repo.git") is None
...
def test_http_scheme_accepted():
    assert validate_url("http://github.com/menukahansda/ask-my-repo") == EXPECTED
